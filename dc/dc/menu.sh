...
main_menu() {
    while true; do
        ...
        echo -e "${CYAN}║${NC}  ${YELLOW}1)${NC} Panel                         ${CYAN}║${NC}"
        echo -e "${CYAN}║${NC}  ${YELLOW}2)${NC} Wings                                ${CYAN}║${NC}"
        echo -e "${CYAN}║${NC}  ${YELLOW}3)${NC} Tools                              ${CYAN}║${NC}"
        echo -e "${CYAN}║${NC}  ${YELLOW}4)${NC} Theme                        ${CYAN}║${NC}"
        echo -e "${CYAN}║${NC}  ${YELLOW}5)${NC} Uninstall                       ${CYAN}║${NC}"
